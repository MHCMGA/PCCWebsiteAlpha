      ...
      h(
        ...
        h(
          ...
          h(
            ...
            h(
              Link,
              { href: `mailto:${SITE.email}`, style: styles.link },
              SITE.email,
            ),
            ` or call ${SITE.phone}.`,
          ),
          ...
          h(
            Text,
            { style: styles.byline },
            "Captive Insurance Consultants \u00b7 Columbia, SC",
          ),
        ),
        h(
          Text,
          ...
          h(
            Link,
            { href: "https://palmettoconsulting.us", style: { color: MUTED } },
