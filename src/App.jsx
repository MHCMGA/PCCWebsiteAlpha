...
export default function App() {
  // Search-console / SEO-tool ownership verification metas. Each one renders
  // only when its env var is set, so the bundle ships safely empty and lights
  // up as you sign up for each service and paste tokens into Vercel.
  const siteVerifications = [
    ...
    },
    {
      ...
      content: import.meta.env.VITE_AHREFS_SITE_VERIFICATION,
    },
  ].filter((v) => v.content);
    ...
    <ErrorBoundary>
      ...
      <Helmet htmlAttributes={{ lang: "en" }}>
        ...
        <meta
          ...
          content="Palmetto Consulting of Columbia, PCC logo"
        />
